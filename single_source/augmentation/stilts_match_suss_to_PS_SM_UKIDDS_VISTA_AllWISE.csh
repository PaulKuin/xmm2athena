...
date
echo 
java -jar /Users/kuin/bin/topcat-full.jar  -stilts cdsskymatch cdstable=II/249/catalog in=singlesourcecat2.fits out=SUSS_SM.fits find=each  ra=ra2000Ep dec=dec2000Ep radius=3 
...
date    
echo 
java -jar /Users/kuin/bin/topcat-full.jar  -stilts cdsskymatch cdstable=II/343/viking2 in=singlesourcecat2.fits out=SUSS_VI.fits find=each  ra=ra2000Ep dec=dec2000Ep radius=3 
...
date                 
 echo 
java -jar /Users/kuin/bin/topcat-full.jar  -stilts cdsskymatch cdstable=II/328/allwise in=singlesourcecat2.fits out=SUSS_WISE.fits find=each  ra=ra2000Ep dec=dec2000Ep radius=3 
echo        AllWISE
date                 
