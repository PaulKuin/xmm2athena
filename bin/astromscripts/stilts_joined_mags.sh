...
java -jar $BIN/topcat-full.jar -stilts tmatch2 in1=$IN in2=$IN2 ifmt1=fits ifmt2=csv \
   ...
   join=all1 find=best1 out=$temp1 ofmt=fits  ocmd='delcols IAUNAME_2'\
   fixcols=dups suffix1=  suffix2=_2 
 
exit

#   the following code was replaced by a python script since this code will ignore 
#   to merge rows which do have any NULL in the fields 
