...
'
date
#there's nothing in out9.fits, because no LAS sources in this summary range.
...
topcat -stilts tskymatch2 in1=SUSS_LAS.fits ifmt1=fits in2=out.fits out=out02.fits ra1='ra_x' dec1='dec_x' ra2='ra_x_2' dec2='dec_x_2' error=0.5 find=best1
topcat -stilts tpipe in=out02.fits out=SUSS_LAS_pet.fits cmd='delcols "ra_x_2 dec_x_2 GroupID GroupSize Separation"'
date
echo
...
echo
topcat -stilts tmatch2 in1=SUSS_GCS_pet.fits ifmt1=fits in2=SUSS_DXS_pet.fits out=temp.fits matcher=exact+exact values1='SRCNUM OBSID' values2='SRCNUM2 OBSID2' find=best1 join=all1 fixcols=none icmd1=' \
...
colmeta -name GCS_zPmag "pZmag"; \
colmeta -name GCS_e_zPmag "e_pZmag"; \
colmeta -name GCS_yPmag "pYmag"; \
colmeta -name GCS_e_yPmag "e_pYmag"; \
colmeta -name GCS_jPmag "pJmag"; \
colmeta -name GCS_e_jPmag "e_pJmag"; \
colmeta -name GCS_hPmag "pHmag"; \
colmeta -name GCS_e_hPmag "e_pHmag"; \
colmeta -name GCS_kPmag "pKmag1"; \
colmeta -name GCS_e_kPmag "e_pKmag1"; \
...
colmeta -name DXS_jPmag "pJmag"; \
colmeta -name DXS_e_jPmag "e_pJmag"; \
colmeta -name DXS_kPmag "pKmag"; \
colmeta -name DXS_e_kPmag "e_pKmag"; \
keepcols "SRCNUM2 OBSID2 DXS_jmag DXS_e_jmag DXS_kmag DXS_e_kmag DXS_jPmag DXS_e_jPmag DXS_kPmag DXS_e_kPmag"' \
ocmd='delcols "SRCNUM2 OBSID2 Separation"'
...
date
echo 
topcat -stilts tmatch2 in1=temp_in.fits ifmt1=fits in2=SUSS_LAS_pet.fits out=temp.fits matcher=exact+exact values1='SRCNUM OBSID' values2='SRCNUM2 OBSID2' find=best1 join=all1 fixcols=none icmd2='colmeta -name SRCNUM2 "SRCNUM"; colmeta -name OBSID2 "OBSID"; \
...
colmeta -name LAS_yPmag "pYmag"; \
colmeta -name LAS_e_yPmag "e_pYmag"; \
colmeta -name LAS_jPmag "pJmag1"; \
colmeta -name LAS_e_jPmag "e_pJmag1"; \
colmeta -name LAS_hPmag "pHmag"; \
colmeta -name LAS_e_hPmag "e_pHmag"; \
colmeta -name LAS_kPmag "pKmag"; \
colmeta -name LAS_e_kPmag "e_pKmag"; \
keepcols "SRCNUM2 OBSID2 LAS_ymag LAS_e_ymag LAS_jmag LAS_e_jmag LAS_hmag LAS_e_hmag LAS_kmag LAS_e_kmag LAS_yPmag LAS_e_yPmag LAS_jPmag LAS_e_jPmag LAS_hPmag LAS_e_hPmag LAS_kPmag LAS_e_kPmag"' \
ocmd='delcols "SRCNUM2 OBSID2 Separation"'
cp temp.fits temp_in.fits
echo
...
echo 
topcat -stilts tpipe in=temp_in.fits out=temp.fits \
cmd='addcol -units mag UK_kPmag "( (DXS_kPmag > 0.0) ? DXS_kPmag : LAS_kPmag )";\
addcol -units mag UK_e_kPmag "( (DXS_kPmag > 0.0) ? DXS_e_kPmag : LAS_e_kPmag )";\
delcols "DXS_kPmag DXS_e_kPmag LAS_kPmag LAS_e_kPmag";\
colmeta -name DXS_kPmag "UK_kPmag";\
colmeta -name DXS_e_kPmag "UK_e_kPmag";\
addcol -units mag UK_kPmag "( (GCS_kPmag > 0.0) ? GCS_kPmag : DXS_kPmag )";\
addcol -units mag UK_e_kPmag "( (GCS_kPmag > 0.0) ? GCS_e_kPmag : DXS_e_kPmag )";\
delcols "GCS_kPmag GCS_e_kPmag DXS_kPmag DXS_e_kPmag"'
cp temp.fits temp_in.fits
echo 
...
topcat -stilts tpipe in=temp_in.fits out=temp.fits \
cmd='\
addcol -units mag UK_hPmag "( (GCS_hPmag > 0.0) ? GCS_hPmag : LAS_hPmag )";\
addcol -units mag UK_e_hPmag "( (GCS_hPmag > 0.0) ? GCS_e_hPmag : LAS_e_hPmag )";\
delcols "GCS_hPmag GCS_e_hPmag LAS_hPmag LAS_e_hPmag"'
cp temp.fits temp_in.fits
echo 
...
topcat -stilts tpipe in=temp_in.fits out=temp.fits \
cmd='\
addcol -units mag UK_jPmag "( (DXS_jPmag > 0.0) ? DXS_jPmag : LAS_jPmag )";\
addcol -units mag UK_e_jPmag "( (DXS_jPmag > 0.0) ? DXS_e_jPmag : LAS_e_jPmag )";\
delcols "DXS_jPmag DXS_e_jPmag LAS_jPmag LAS_e_jPmag";\
colmeta -name DXS_jPmag "UK_jPmag";\
colmeta -name DXS_e_jPmag "UK_e_jPmag";\
addcol -units mag UK_jPmag "( (GCS_jPmag > 0.0) ? GCS_jPmag : DXS_jPmag )";\
addcol -units mag UK_e_jPmag "( (GCS_jPmag > 0.0) ? GCS_e_jPmag : DXS_e_jPmag )";\
delcols "GCS_jPmag GCS_e_jPmag DXS_jPmag DXS_e_jPmag"'
cp temp.fits temp_in.fits
echo 
...
topcat -stilts tpipe in=temp_in.fits out=temp.fits \
cmd='\
addcol -units mag UK_yPmag "( (GCS_yPmag > 0.0) ? GCS_yPmag : LAS_yPmag )";\
addcol -units mag UK_e_yPmag "( (GCS_yPmag > 0.0) ? GCS_e_yPmag : LAS_e_yPmag )";\
delcols "GCS_yPmag GCS_e_yPmag LAS_yPmag LAS_e_yPmag"'
cp temp.fits temp_in.fits
echo 
echo Rename Petrosian Z magnitudes.
date
echo 
topcat -stilts tpipe in=temp_in.fits out=SUSS_UK_pet.fits \
cmd='\
colmeta -name UK_zPmag "GCS_zPmag";\
colmeta -name UK_e_zPmag "GCS_e_zPmag"'
