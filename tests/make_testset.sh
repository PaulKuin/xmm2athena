...
java -jar /Users/kuin/bin/topcat-full.jar -stilts tmatch2 in1=$1"#2" ifmt1=fits in2=test_cat.fit ifmt2=fits out=test_cat_summary.fits icmd2='keepcols "N_SUMMARY OBSID"' matcher=exact+exact values1='N_SUMMARY OBSID' values2='N_SUMMARY OBSID' find=best1 join=1and2  ocmd='delcols "N_SUMMARY_2 OBSID_2 Separation"' ocmd='colmeta -name N_SUMMARY "N_SUMMARY_1";colmeta -name OBSID "OBSID_1"'
date
echo
